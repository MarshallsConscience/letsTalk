 ...
 canHandle(handlerInput) {
    ...
    handle(handlerInput){
        ...
        if(i === 4) {
            ...
            const hobby = ['listen to some music. Would you like me to play anything in particular?', 'listen to a podcast. Do you have anything in mind that you would like to listen to?', ' do some light exercise. Maybe take a walk in the park and get some fresh air?',' go out and have a dance. Want me to look up some dance classes near you?'];
